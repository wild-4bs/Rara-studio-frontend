...
import { EquipmentRentalPageContent } from "@/types/pages";
import { Loader } from "@/components/Loader";
import clsx from "clsx";

export const Content = () => {
  const { data, isFetched } = useGetPageContents("equipment-rental");
  const page = data as EquipmentRentalPageContent;
